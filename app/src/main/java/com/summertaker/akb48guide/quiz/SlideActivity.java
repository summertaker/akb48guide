    ...
    private void updateData() {
        ...
        if (mMemberList.size() == 0) {
            ...
            if (loContent != null) {
                ...
                switch (mGroupData.getId()) {
                    case Config.GROUP_ID_AKB48:
                        width = (int) (320 * mDensity);
                        //margin = (int) (50 * mDensity);
                        mParams = new LinearLayout.LayoutParams(width, LinearLayout.LayoutParams.WRAP_CONTENT);
                        //mParams.setMargins(0, margin, 0, 0);
                        break;
                    case Config.GROUP_ID_JKT48:
                        width = (int) (216 * mDensity);
                        //margin = (int) (50 * mDensity);
                        mParams = new LinearLayout.LayoutParams(width, LinearLayout.LayoutParams.WRAP_CONTENT);
                        //mParams.setMargins(0, margin, 0, 0);
                        break;
    ...
    private void renderPicture() {
        ...
        if (imageUrl == null || imageUrl.isEmpty()) {
            ...
            if (mIsAllDataLoaded) {
                ...
                /*
                ImageView가 높이 계산에 문제가 있어 ProportionalImageView 사용함.
                런타임에 ImageView 사용하는 경우 ProportionalImageView 사용할 것
                 */
