    ...
    private void renderPicture(final View rootView) {
        ...
        switch (mMemberData.getGroupId()) {
            case Config.GROUP_ID_AKB48:
                ivPicture = (ImageView) rootView.findViewById(R.id.ivPictureFixed);
                break;
            case Config.GROUP_ID_JKT48:
                ivPicture = (ImageView) rootView.findViewById(R.id.ivPictureBordered);
                break;
            default:
                ivPicture = (ImageView) rootView.findViewById(R.id.ivPictureFull);
                break;
        }
