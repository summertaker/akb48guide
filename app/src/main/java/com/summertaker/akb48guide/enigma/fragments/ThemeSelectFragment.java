...
import com.summertaker.akb48guide.enigma.common.Memory;
...
public class ThemeSelectFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View view = LayoutInflater.from(Shared.context).inflate(R.layout.enigma_theme_select_fragment, container, false);
