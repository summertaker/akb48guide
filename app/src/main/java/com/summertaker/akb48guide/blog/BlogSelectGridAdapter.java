...
public class BlogSelectGridAdapter extends BaseDataAdapter {
    ...
    public BlogSelectGridAdapter(Context context, ArrayList<SiteData> dataList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = mLayoutInflater.inflate(R.layout.blog_select_grid_item, null);
