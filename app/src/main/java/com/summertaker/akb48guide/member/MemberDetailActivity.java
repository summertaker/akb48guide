...
public class MemberDetailActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*String locale = Util.getLocaleStrng(MemberDetailActivity.this);
        String name = null;
        if ("KR".equals(locale)) {
    ...
    private void renderProfile() {
        ...
        switch (mGroupData.getId()) {
            case Config.GROUP_ID_SKE48:
                captain = getString(R.string.leader);
                viceCaptain = getString(R.string.vice_leader);
                break;
            default:
                captain = getString(R.string.captain);
                viceCaptain = getString(R.string.vice_captain);
                break;
        }
    ...
    private void renderProfilePicture() {
        ...
        switch (mGroupData.getId()) {
            case Config.GROUP_ID_AKB48:
                imageView = (ImageView) findViewById(R.id.ivPictureFixed);
                break;
            case Config.GROUP_ID_JKT48:
                imageView = (ImageView) findViewById(R.id.ivPictureBordered);
                break;
            default:
